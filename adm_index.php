...
<body id="page-top">
    ...
    <div class="container-fluid">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php
                                    $count = "SELECT stid FROM student";
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Monthly Cost</h6>
                        <div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Most Requested Medicines / Most Used Medicines
                        </h6>
                        <div>
    ...
    <script>
        function updateCharttt() {
            ...
            xhttp.open("GET", "fetchpieIndex.php?year=" + year, true);
            xhttp.send();
        }
    </script>
    <script>
